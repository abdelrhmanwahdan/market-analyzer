...
_EGX_NAMES = {
    ...
    "ORWE": "Oriental Weavers", "JUFO": "Juhayna Food",
    "OCDI": "SODIC", "SKPC": "Sidi Kerir Petrochem", "GBCO": "GB Auto",
    "RAYA": "Raya Holding", "CLHO": "Cleopatra Hospital",
    ...
    "ORHD": "Orascom Hotels", "EMFD": "Emaar Misr",
    "RACC": "Raya Contact Center", "TALM": "Taaleem Management",
    "FAIT": "Faisal Islamic Bank EGP",
}

_EGX_SECTORS = {
    "SWDY": "Industrials", "TMGH": "Real Estate", "ETEL": "Telecom",
    "PHDC": "Real Estate", "ABUK": "Materials", "ORWE": "Consumer",
    "JUFO": "Consumer Staples", "OCDI": "Real Estate",
    "SKPC": "Energy", "GBCO": "Consumer",
    ...
    "RACC": "Technology", "TALM": "Education", "FAIT": "Islamic Banking",
}
